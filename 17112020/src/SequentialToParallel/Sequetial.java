...
public class Sequetial {
    public static void main(String[] args) {
        long startTime = System.currentTimeMillis();
        BufferedImage inputImage = null;

        try {
            inputImage = ImageIO.read(new File("17112020/gris.png")); //caricamento immagine
        } catch (IOException e) {
    ...
    /*Creo i due colori che utilizzerò per l'immagine finale*/
        ...
        try {
            ImageIO.write(outputImage, "png", new File("17112020/outputImage.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
